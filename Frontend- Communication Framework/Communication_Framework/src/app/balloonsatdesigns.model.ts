export interface Balloonsatdesign{

DesignNumber: number,

FocalLength_mm: number,

SensorSize_mm: number,

AngularFieldofView: number,

PayloadHeight_m: number,
...
GainPayloadAntenna_dB: number,

SatelliteReceivedPower_dB: number,

NoiseTemperaturePayload_K: number,
