...
import { UavdesignService } from '../uavdesigns.service';


@Component({
  selector: 'app-uavdesigns',
  templateUrl: './uavdesigns.component.html',
  styleUrls: ['./uavdesigns.component.css']
})
export class UavdesignsComponent implements OnInit {

  constructor(public UavdesignService: UavdesignService) { }
  private uavdesignSub: Subscription;
  uavdesigns: Uavdesign[]=[];
  onAdd( DesignNumber: string,
    ...
    this.UavdesignService.addUavdesign(DesignNumber,
  ...
  ngOnInit(): void {
    ...
    this.uavdesignSub = this.UavdesignService.getUavdesign()
    .subscribe((uavdesign: Uavdesign[])=> {
    
    this.uavdesigns = uavdesign;
  });
  }
